...
def len_four(atom_names, input_shape, normalizer, quantize='one-hot', with_since=False):
    CHOICE_CONFIG = {}
    ...
    tp1_andor, CHOICE_CONFIG = \
        build_andor_choice('tp1', atom1_choice, atom2_choice, CHOICE_CONFIG, quantize=Q)
    ...
    if with_since:
        ...
        # C(aUb)
        until1_output = build_since('tp2', T, [atom1_choice, atom2_choice])
